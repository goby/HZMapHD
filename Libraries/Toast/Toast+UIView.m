...
static const NSString *CSToastMainViewKey          = @"CSToastMainViewKey";
                     ...
                     animations:^{
                         ...
                         [UIView animateWithDuration:CSToastFadeDuration
                                          ...
                                          animations:^{
                                              ...
                                              objc_setAssociatedObject(self, &CSToastMainViewKey, nil, OBJC_ASSOCIATION_ASSIGN);
                                          }];
                     }];
}
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    UIView *wrapperView = (UIView *)objc_getAssociatedObject(self, &CSToastMainViewKey);
    ...
    objc_setAssociatedObject(self, &CSToastMainViewKey, wrapperView, OBJC_ASSOCIATION_ASSIGN);
    return wrapperView;
}
